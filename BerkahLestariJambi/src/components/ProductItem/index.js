    ...
    <div class=" border rounded-lg">
      ...
      <div className=" p-4  text-white">
        ...
        <div>
          ...
          <p>Wilayah: {item?.kabupaten?.nama}</p>
        </div>
    ...
    <>
      ...
      >
        <div>
          ...
          {/* input qty */}
          <div className="mt-4">
            <p className="text-lg font-bold mb-2">Jumlah</p>
          ...
          <Button
            type="primary"
            className="bg-purple-600 text-white hover:bg-purple-700 hover:text-white mt-4 w-full disabled:bg-gray-400"
            onClick={() => {
              setIsModalOpen(false)
              onOrder({ ...user, qty })
            }}
          ...
          >
            {item.product_stock === 0 ? "Stok Habis" : "Beli Sekarang"}
          </Button>
        </div>
      </Modal>
    </>
